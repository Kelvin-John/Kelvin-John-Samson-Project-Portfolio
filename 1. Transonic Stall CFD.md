...
- This project started with me trying to model tranonic buffet and quickly realizing that the copmutational demand for that would be exorbidant which is why I switched to 2D even though its not physically accurate it would pose a good oppertunity to get acquainted with the solver setup, futher I realsed that even to solve for a sufficient flow time whilst maintaining a relatively low y+ and cfl number so as to ensure solver convergence including the animations which were generated during the solution this took about 9 hours with a Ryzen 7 7840hs and 16 gigabytes of ram.<br>
